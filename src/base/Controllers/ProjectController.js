...
var ProjectController = {
  ...
  getProjectAnalyses: function(input, callback) {
    ...
    function cb(_error, _response, _context) {
      if (_error) {
        callback(
          { errorMessage: _error.message, errorCode: _error.code },
          null,
          _context
        );
  ...
  getSavedFilters: function(input, callback) {
    ...
    var _queryBuilder =
      _baseUri + "/projects/{username}/{project_slug}/filters";
  ...
  getSavedFilter: function(input, callback) {
    ...
    var _queryBuilder =
      _baseUri + "/projects/{username}/{project_slug}/filters/{identifier}";
  ...
  getProjectUrlsAggs: function(input, callback) {
    ...
    var _queryBuilder =
      _baseUri + "/projects/{username}/{project_slug}/urls/aggs";
