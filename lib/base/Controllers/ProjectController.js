...
var ProjectController = {
   ...
   */
  getProjectAnalyses: function getProjectAnalyses(input, callback) {
   ...
   */
  testUrlRewritingRules: function testUrlRewritingRules(input, callback) {
    //Assign default values
    input = input || {};
   ...
   */
  getSavedFilters: function getSavedFilters(input, callback) {
    //Assign default values
    input = input || {};
   ...
   */
  getSavedFilter: function getSavedFilter(input, callback) {
    //Assign default values
    input = input || {};
   ...
   * @return {mixed}
   */
  getProjectUrlsAggs: function getProjectUrlsAggs(input, callback) {
    //Assign default values
    input = input || {};
