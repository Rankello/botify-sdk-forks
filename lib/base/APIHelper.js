...
var APIHelper = {
     ...
     */
    appendUrlWithTemplateParameters: function appendUrlWithTemplateParameters(queryBuilder, parameters) {
     ...
     */
    appendUrlWithQueryParameters: function appendUrlWithQueryParameters(queryBuilder, parameters) {
        //perform parameter validation
        if (queryBuilder == null) {
            console.log('queryBuilder is null');
            return;
     ...
     */
    jsonSerialize: function jsonSerialize(data) {
     ...
     */
    cleanObject: function cleanObject(input) {
     ...
     */
    isPrimitiveArray: function isPrimitiveArray(value) {
     ...
     */
    formDataEncodeObject: function formDataEncodeObject(obj, keys) {
        var query = '',
            key,
            value,
            fullSubName,
     ...
     * @return {String}
     */
    urlEncodeObject: function urlEncodeObject(obj) {
